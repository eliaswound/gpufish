...
from gpufish.functions.checks.check_image import check_cupy_array, check_tiff_dtype, return_to_original_dtype, fit_to_float
...
def log_filter(image, sigma):
    ...
    check_cupy_array(image_float)
    check_tiff_dtype(image_float)
